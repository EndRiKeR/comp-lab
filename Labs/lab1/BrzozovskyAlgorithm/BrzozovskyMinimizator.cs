...
namespace comp_lab.Labs.lab1.BrzozovskyAlgorithm;

public class BrzozovskyMinimizator(DfaBuilder dfaBuilder) // трепещи, Перри Утконос
{
    public Dfa.Dfa Minimize(Dfa.Dfa dfa, bool isCompact = false, bool withOutput = false)
    {
    ...
    private Nfa.Nfa Reverse(Dfa.Dfa dfa)
    {
        ...
        return new Nfa.Nfa(nfaTransitions);
    }

    private Dfa.Dfa Determinate(Nfa.Nfa nfa, bool isCompact = false)
    {
