...
{
    public void CreateDfa(string testRegex, bool isCompact, bool withOutput, int i, out Dfa dfa, out Dfa minDfa)
    {
        Console.WriteLine($"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    ...
    public void TestWords(Dfa dfa, List<string> testWords, string regex)
    {
        Console.WriteLine();
